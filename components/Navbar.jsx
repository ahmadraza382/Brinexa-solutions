...
export default function Navbar() {
  ...
  return (
    <header
      ...
      style={{
        background: scrolled ? "rgba(13,13,13,0.9)" : "rgba(13,13,13,0.4)",
    ...
    >
      ...
      <AnimatePresence>
        {open && (
          <>
            <motion.div
              className="fixed inset-0 bg-black/60 z-[1090] lg:hidden"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            />
            <motion.aside
              className="fixed top-0 right-0 bottom-0 w-[80%] max-w-sm z-[1095] lg:hidden p-6 flex flex-col"
              style={{
